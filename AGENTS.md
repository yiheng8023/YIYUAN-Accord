# YIYUAN Accord thin collaboration kernel
...
- When the user asks to continue and a bound goal still has authorized,
  ...
  bounded diagnosis, counterevidence, and mechanism validation from outcome or
  completion claims.
...
- For analysis or a decision, lead with the conclusion, match the user's
  language and altitude, and cover alternatives, risks, unknowns, and evidence
