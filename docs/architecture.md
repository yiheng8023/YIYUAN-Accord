...
The current v1.1 program is `active`, has one outcome-neutral terminal-human-
authorization trust-and-public-privacy increment, and has one source-authorized,
