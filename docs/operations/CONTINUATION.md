...
v1.2 has O1 at 1/5 and one active, outcome-neutral O2 public-observation replay
increment. Its frozen
candidate.2 binding and O1 registration precede the accepted 12/12 controlled
result. The O1 suite is the only accepted outcome validator; O2 may add only
bounded public-safe projection replay before installation or measurement and
remains false.
