...
`increment.product-control-reset` reached its stop condition in commit
`e4092e1`: 1764 indexed predecessor/unmapped files were removed, the current
index was reduced to 35 files, predecessor identity and authority-path matches
were zero, 18 product tests passed, and the commit was pushed to `origin/main`.
