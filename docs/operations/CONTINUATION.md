...
v1.2 freeze remains inactive: an exact human-selected signer must be prebound
before a binding-only signed commit and later pin. No signer or grant exists;
no v1.1 state is inherited.
v1.1 is stopped at
