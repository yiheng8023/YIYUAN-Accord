...
v1.2 is `ready`; O1 is 1/5. Two closed outcome-neutral slices bind the O4 seam
to raw Codex host and repository observations before registration; they perform
