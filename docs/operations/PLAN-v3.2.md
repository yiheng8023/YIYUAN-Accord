...
| 工序 | 当前进度 | 执行步骤 | 验收出口 |
|---|---|---|---|
| 本轮源头与开发路线校准 | 本地实现，未发布 | 按原始需求核对用户结果、必要底线、实际缺口和当前投入；区分用户要求与自选试验手段。用户纠正、重复失败而无新增信息、阶段切换或投入不能关闭关键缺口时，先复核开发路线并调整受影响工序，停止无效支线，继续无真实依赖的工作。沿用源数据与 update plan 的映射，不新增常驻监控或每步审查仪式。 | 本轮方向偏移、原因、保留与停止的工作及下一选择依据明确；源、计划和交接一致并完成受影响检查。进度以必要缺口闭合衡量，不能由提交数、测试数、局部 PASS 或关闭发布门禁代替。此出口仅关闭本轮路线校准。 |
| 普通入口交付、能力适配与实际纠偏 | 进行中 | 对应 codex-function 与 claude-code-function，补齐现有用例未表达的必要职责和场景。先从真实用户结果选择最短充分的端到端验证，核对普通入口、有效权限、实际介入、交付、纠正与收束。按已证明的功能缺口修复或删并机制，工程优化随受影响结果推进。此阶段同步准备可复用的价值对照；不以 Claude 生命周期通过为前置，也不把多列覆盖标签当充分判据。 | 两宿主各自必要结果与适用故障后态均有独立可观察证据，按受影响依赖复用历史事实。加载、工具可调用、原生完成或评估器救援分别记账，不冒充 Accord 效果；未满足的结果保持未完成。 |
...
| Accord 对 Agent 的净影响、干扰与故障验收 | 待开展 | 对应尚未定义的 product-value，先复核普通入口及最小可交付组合，预绑定能辨别实际增益与干扰的同条件比较，尽早随相关功能用例采集，不能等所有支线完结才考虑价值。先核对各臂真实注入、交付、授权、必要检查和正常收束，再比较 Token、耗时、无效探索、人工补救与残留。Token 增量本身不等于副作用；无增益或负面结果必须允许推翻机制选择，不能靠换提示词、模型或预算反复寻求通过。 | 所声明收益有匹配条件和独立结果支持，必要质量底线不被平均分掩盖；原生充分、外援、负面干扰与救援成本均被识别。联合核对适用的纠正、恢复及资源后态，仅对实际转移检查目的端和来源释放。证据不足则保持净价值未验证。 |
...
| 质量维度 | 必要底线 | 承担工序 | 当前验收 |
|---|---|---|---|
| 合规与安全 | No unauthorized or prohibited effects; truthful claim and ownership handling. | 本轮源头与开发路线校准、普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | 未验证 |
| 功能覆盖 | Every bound function and quality requirement is fulfilled through an available executor. | 本轮源头与开发路线校准、普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、3.2 定版、发布与收尾 | 未验证 |
| 普通入口集成 | The selected ordinary entry connects trigger, current facts, decision, execution and independent post-state. | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复 | 未验证 |
| 恢复与生命周期 | Applicable failure, restoration, continuity, update and removal paths preserve user state and close attributable residue. | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | 未验证 |
| 变化适应 | Relevant host, model, permission and active-package drift invalidates and revalidates only dependent assumptions and claims. | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | 未验证 |
| 证据完整性 | Current claims bind current subjects; independent observation and experimental execution remain distinguished. | 本轮源头与开发路线校准、普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | 未验证 |
| 用户负担与干扰 | Necessary human decisions remain human-owned while Agent mechanics and unnecessary ceremony are not transferred to the user. | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | 未验证 |
| 可维护性与资源成本 | Verification, context, modules and resource use remain sustainable without weakening functional or evidence guarantees. | 普通入口交付、能力适配与实际纠偏、两宿主安装、更新与独立恢复、3.2 定版、发布与收尾 | 未验证 |
...
| 职责 | 所属工序 | 历史需求与反例参考 |
|---|---|---|
| 目标、授权与用户纠正 | 本轮源头与开发路线校准、普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、3.2 定版、发布与收尾 | GT-03, GT-04, GT-10, GT-13 |
| 环境感知与自身能力识别 | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收 | GT-08, GT-14, GT-19 |
| 按需研究、学习与复用发现 | 普通入口交付、能力适配与实际纠偏 | GT-15 |
| 关系判断、路线与形态选择 | 普通入口交付、能力适配与实际纠偏 | GT-13, GT-16, GT-17 |
| 执行、配置与代码操作 | 普通入口交付、能力适配与实际纠偏、两宿主安装、更新与独立恢复 | GT-02, GT-11, GT-16 |
| 源头变更与全局一致性 | 本轮源头与开发路线校准、普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、3.2 定版、发布与收尾 | GT-17 |
| 纠错、经验吸收与受控演进 | 普通入口交付、能力适配与实际纠偏、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收 | GT-05, GT-18 |
| 故障恢复与回滚 | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | GT-18, GT-20 |
| 上下文与任务连续性 | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、Accord 对 Agent 的净影响、干扰与故障验收 | GT-07, GT-21 |
| 资源管理与清理 | 普通入口交付、能力适配与实际纠偏、Desktop 连续性与归档授权边界、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | GT-09, GT-12 |
| 安装、更新与卸载生命周期 | 两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | GT-20 |
| 原生接替、旁路与退役 | 普通入口交付、能力适配与实际纠偏 | GT-01, GT-19 |
| 结果验证、独立证据与实际价值 | 本轮源头与开发路线校准、普通入口交付、能力适配与实际纠偏、两宿主安装、更新与独立恢复、Accord 对 Agent 的净影响、干扰与故障验收、3.2 定版、发布与收尾 | GT-04, GT-06, GT-14 |
...
The current host Skill supplies adaptive guidance, not a proven system executor. Historical dev.2 native repair and same-session resume observations do not qualify this candidate, incremental value, surviving failure ownership, zero-history handoff or package lifecycle. closure.py remains a no-I/O reference core: callers supply candidates and comparison facts; it does not discover tools or establish their truth. Keeping that reference outside the ordinary entry is not itself a defect. The uncalled simulated graph demonstration has been retired from the current tree; its historical paths resolve at their original revisions. Needed discovery, decisions and effects still require sufficient observable host or composed execution. The demonstrated gap spans ownership and delivery, not only dynamic adaptation: no ordinary-entry caller currently connects the reference decisions to fresh sources, affected-state updates and executed post-state. Review the necessary control allocation across all duties and implement the smallest real path before claiming production sufficiency. A simple order-file diagnostic does not close customized-environment adaptation or that allocation.
