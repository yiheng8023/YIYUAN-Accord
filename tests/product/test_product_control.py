...
class ProductControlTests(unittest.TestCase):
    ...
    def test_current_v02_contract_retains_two_verified_outcomes_during_context_boundary_task(self) -> None:
        ...
        self.assertEqual(
            ...
            "increment.v0.2.codex-context-carrier-boundary-decision",
        )
