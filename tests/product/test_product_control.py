...
from harness.task_validator_o4_continuous_self_correction_v3 import (  # noqa: E402
    INCREMENT_ID as O4_CONTINUOUS_CORRECTION_V3_INCREMENT_ID,
    VALIDATOR_KIND as O4_CONTINUOUS_CORRECTION_V3_VALIDATOR_KIND,
    VALIDATOR_LOCATOR as O4_CONTINUOUS_CORRECTION_V3_VALIDATOR_LOCATOR,
    validate_evidence as validate_o4_continuous_correction_v3_evidence,
    validate_registration as validate_o4_continuous_correction_v3_registration,
)
...
class ProductControlTests(unittest.TestCase):
    ...
    def test_current_v12_contract_is_valid_with_two_stopped_o4_counterexamples(
        self,
    ) -> None:
        ...
        self.assertEqual(current_o4["state"], "stopped")
        self.assertEqual(current_o4["acceptanceIds"], ["O4", "G2", "G4"])
        self.assertEqual(current_o4["workItems"][0]["state"], "stopped")
        self.assertEqual(
        ...
        stopped_v2 = json.loads(
            (
                ROOT
                / "product/evidence/o4-continuous-self-correction-second-generation-stopped-2026-08-19.json"
            ).read_text(encoding="utf-8")
        )
        self.assertEqual(stopped_v2["deterministicStop"]["taskThreadsCreated"], 0)
        self.assertEqual(stopped_v2["deterministicStop"]["modelTurnsExecuted"], 0)
        self.assertIs(stopped_v2["faultSuite"]["allFaultControlsObserved"], True)
        self.assertIs(stopped_v2["cleanup"]["isolatedCodexEnvironmentRemoved"], True)
        self.assertIs(stopped_v2["acceptanceEffect"]["o4Credit"], False)
    ...
    def test_current_release_has_only_the_supported_task_specific_validators(self) -> None:
        ...
        o4_v3_expected_prefix = (
            frozenset({"O4"}),
            frozenset({O4_CONTINUOUS_CORRECTION_V3_INCREMENT_ID}),
            O4_CONTINUOUS_CORRECTION_V3_VALIDATOR_LOCATOR,
        )
        self.assertEqual(
            set(SUPPORTED_EVIDENCE_VALIDATORS),
            {
                ...
                O4_CONTINUOUS_CORRECTION_V3_VALIDATOR_KIND,
            },
        )
        self.assertEqual(
        ...
        self.assertIs(
            ...
            validate_o4_continuous_correction_v3_evidence,
        )
        self.assertEqual(
            SUPPORTED_PRE_MEASUREMENT_VALIDATORS[
                O4_CONTINUOUS_CORRECTION_V3_VALIDATOR_KIND
        ...
        self.assertIs(
            ...
            validate_o4_continuous_correction_v3_registration,
        )
