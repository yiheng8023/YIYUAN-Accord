#!/usr/bin/env python3
"""Validate the visual-method zero-model effect protocol."""
...
def validate_protocol(root: Path = ROOT) -> dict[str, Any]:
    ...
    _require(
        ...
        "Visual-method evaluator outcome drifted",
    )
    _require(
