        ...
        if carrier_handoff:
            ...
            if carrier_session:
                contract["optionalCarrierHandoff"]["sourceSession"] = {
                    ...
                    "controllerRestoration": "settled-transfer-only; explicit-acknowledged-inactive-scope-basis; independently-quiesced-prior-controller-and-reconciled-effects; claim-and-readback-before-native-resume; summary-reads-and-excludeTurns; verified-current-settings-history-and-native-tools; final-token-readback; old-basis-and-stale-executor-rejected",
