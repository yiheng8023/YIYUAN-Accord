...
outcome-neutral O2 validator-seam increment from the current graph. Its exact prior revision immutably registered
...
The tree contains a strictly pre-registration, evidence-fail-closed O2
validator seam; it cannot install or execute the candidate and cannot promote
O2. The Codex source has been reduced to
