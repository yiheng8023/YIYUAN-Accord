...
outcome-neutral O2 seam and public-observation replay slices from the current
graph. Its exact prior revision immutably registered
...
filesystem manifests. They cannot install or execute the candidate and cannot
