...
> **当前分支正在开发 3.2。** 包版本为 `3.2.0-dev.3`，尚未正式发布，也不会自动更新你安装的版本。已发布的 [v3.1.0](https://github.com/yiheng8023/YIYUAN-Accord/releases/tag/v3.1.0) 保持不变。
>
...
原生能力或已有授权生态足够，就直接利用；存在关键缺口，再查官方资料与成熟方案，决定是否组合或自建。调研要帮助解决问题，并及时回到交付。
