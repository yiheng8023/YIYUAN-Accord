...
v1.2 正在进行一次全局减法重塑。[product/program.json](product/program.json)
中的无 token budget 精确目标已在具名用户授权后，于 2026-08-20 在当前宿主任务恢复为
active。目标生命周期只授权继续执行有边界的收官工作，不构成验收、发布或真实场域效果证据。
