...
后续 `f0ed9ce715afdbc5d9eb75e08225e9a1e46c554c` 的 GT-17/18 尝试虽通过旧
验证器，但独立复审发现 GT-17 清理未绑定来源，GT-18 也未保留每阶段完整向量及载体
源/目标状态，因此只能作为来源不充分的反例。当前工序是在加强后的失败闭锁契约下
有界重放 GT-17/18；真实机制、受控演化、持久连续性、跨宿主或群体价值与发布仍受门控，
全系统平衡自审在其后执行。
