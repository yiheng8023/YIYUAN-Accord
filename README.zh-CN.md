...
四个有界 outcome-neutral 切片已在未来注册之前提交 O4 专属验证器，把公开安全投影绑定到
Codex 原始宿主消息和仓库观察，要求一个精确公开受控目标在原生压缩与全历史 deferred-goal
分叉前后保持 active，并要求来源 goal 在归档来源载体前通过原生生命周期清除，随后退出当前图。
四次切片都不执行 O4 测量，也不获得结果信用。
