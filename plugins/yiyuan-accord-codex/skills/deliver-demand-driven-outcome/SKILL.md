...
declared representative tasks against the exact host and Skill.
**Static readiness is not behavior**; install/enable is not value. For
ordinary work, skip that ceremony.
